/*
 * To run this code, you have to use Google Earth Engine code platform.
 */
...
// averaging MODIS Aqua data for four year.
var modisOceanColor = ee.ImageCollection('NASA/OCEANDATA/MODIS-Aqua/L3SMI');
var sst =
    modisOceanColor.select(['sst']).filterDate('2017-01-01', '2021-11-10');

var vis = {min: 0, max: 35, palette: 'navy,#3892ff,#ffac47'};
...
var intro = ui.Panel([
  ui.Label({
    value: 'Masih dalam pengembangan: SPL Investigator',
    style: {fontSize: '20px', fontWeight: 'bold'}
  }),
  ui.Label('Klik lokasi untuk melihat fluktuasi Suhu Permukaan Laut (SPL).')
]);
...
var generateChart = function (coords) {
  ...
  // Customize the chart.
  sstChart.setOptions({
    title: 'Suhu Permukaan Laut (SPL): Time Series',
    vAxis: {title: 'Suhu (C)'},
...
var legendTitle = ui.Label({
  value: 'Map Legend: Rata-rata Suhu Permukaan Laut (C)',
...
var initialPoint = ee.Geometry.Point(124.08, -3.86);
